    ...
    return DataConfig(
        ...
        augmentation_config=AugmentationConfig(
            intensity=IntensityConfig(
                ...
                brightness=tuple(legacy_config.get("optimization", {}).get("augmentation_config", {}).get("brightness_min_val", 1.0), 
        ...
        #         rotation=legacy_config.get("augmentation", {}).get("rotation", 15.0),
        #         scale=legacy_config.get("augmentation", {}).get("scale", [0.9, 1.1]),
        #         translate_width=legacy_config.get("augmentation", {}).get("translate_width", 0.2),
        #         translate_height=legacy_config.get("augmentation", {}).get("translate_height", 0.2),
        #         affine_p=legacy_config.get("augmentation", {}).get("affine_p", 0.0),
        #         erase_scale_min=legacy_config.get("augmentation", {}).get("erase_scale_min", 0.0001),
        #         erase_scale_max=legacy_config.get("augmentation", {}).get("erase_scale_max", 0.01),
        #         erase_ratio_min=legacy_config.get("augmentation", {}).get("erase_ratio_min", 1.0),
        #         erase_ratio_max=legacy_config.get("augmentation", {}).get("erase_ratio_max", 1.0),
        #         erase_p=legacy_config.get("augmentation", {}).get("erase_p", 0.0),
        #         mixup_lambda=legacy_config.get("augmentation", {}).get("mixup_lambda", [0.01, 0.05]),
        #         mixup_p=legacy_config.get("augmentation", {}).get("mixup_p", 0.0),
        #     )
