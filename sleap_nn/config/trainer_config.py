...
def trainer_mapper(legacy_config: dict) -> TrainerConfig:
    ...
    return TrainerConfig(
        train_data_loader=DataLoaderConfig(
            ...
            # num_workers=legacy_config_optimization
        ...
        model_ckpt=ModelCkptConfig(
            # save_top_k=legacy_config_outputs
            # .get("save_top_k", 1),
            save_last=legacy_config_outputs.get("save_outputs", False),
        ),
        # trainer_devices=legacy_config_optimization
        # .get("trainer_devices", "auto"),
        # trainer_accelerator=legacy_config_optimization
        # .get("trainer_accelerator", "auto"),
        # enable_progress_bar=legacy_config_optimization
        # .get("enable_progress_bar", True),
        # steps_per_epoch=legacy_config_optimization
        # .get("steps_per_epoch", None),
        max_epochs=legacy_config_optimization.get("epochs", 10),
        # seed=legacy_config_optimization
        # .get("seed", None),
        # use_wandb=legacy_config_optimization
        # .get("use_wandb", False),
        save_ckpt=legacy_config_optimization.get("checkpointing", {}).get(
            "latest_model", False
        ),
        # save_ckpt_path=legacy_config_optimization
        # .get("save_ckpt_path", "./"),
        # resume_ckpt_path=legacy_config_optimization
        # .get("resume_ckpt_path", None),
        # wandb=WandBConfig(
        #     entity=legacy_config_optimization
        #     .get("wandb", {})
        #     .get("entity", None),
        #     project=legacy_config_optimization
        #     .get("wandb", {})
        #     .get("project", None),
        #     name=legacy_config_optimization
        #     .get("wandb", {})
        #     .get("name", None),
        #     api_key=legacy_config_optimization
        #     .get("wandb", {})
        #     .get("api_key", None),
        #     wandb_mode=legacy_config_optimization
        #     .get("wandb", {})
        #     .get("wandb_mode", None),
        #     prv_runid=legacy_config_optimization
        #     .get("wandb", {})
        #     .get("prv_runid", None),
        #     group=legacy_config_optimization
        #     .get("wandb", {})
        #     .get("group", None),
        # ) if legacy_config_optimization.get("use_wandb", False) else None,
        ...
        optimizer=OptimizerConfig(
            ...
            # amsgrad=legacy_config_optimization
            # .get("optimizer", {})
            # .get("amsgrad", False),
        ),
        lr_scheduler=(
            LRSchedulerConfig(
                ...
                #     step_size=legacy_config_optimization
                #     .get("lr_scheduler", {})
                #     .get("step_lr", {})
                #     .get("step_size", 10),
                #     gamma=legacy_config_optimization
                #     .get("lr_scheduler", {})
                #     .get("step_lr", {})
                #     .get("gamma", 0.1),
                # ) if legacy_config_optimization.get("lr_scheduler", {}).get("scheduler") == "StepLR" else None,
                reduce_lr_on_plateau=ReduceLROnPlateauConfig(
                    # threshold=legacy_config_optimization
                    # .get("lr_scheduler", {})
                    # .get("reduce_lr_on_plateau", {})
                    # .get("threshold", 1e-4),
                    # threshold_mode=legacy_config_optimization
                    # .get("lr_scheduler", {})
                    # .get("reduce_lr_on_plateau", {})
                    # .get("threshold_mode", "rel"),
                    # cooldown=legacy_config_optimization
                    # .get("lr_scheduler", {})
                    # .get("reduce_lr_on_plateau", {})
                    # .get("cooldown", 0),
                    ...
                    # factor=legacy_config_optimization
                    # .get("lr_scheduler", {})
                    # .get("reduce_lr_on_plateau", {})
                    # .get("factor", 0.1),
