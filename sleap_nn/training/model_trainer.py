...
#         self.min_train_steps_per_epoch = self.config.trainer_config.min_train_steps_per_epoch
...
#                 ensure_rgb=self.config.data_config.preprocessing.ensure_rgb,
#                 ensure_grayscale=self.config.data_config.preprocessing.ensure_grayscale,
...
#         if self.min_train_steps_per_epoch is None:
#             self.min_train_steps_per_epoch = (
#                 len(self.train_dataset)
#                 // self.config.trainer_config.train_data_loader.batch_size
#             )
#             if self.min_train_steps_per_epoch == 0:
#                 self.min_train_steps_per_epoch = 1
...
#             # min_train_steps_per_epoch=self.min_train_steps_per_epoch,
...
#             # min_train_steps_per_epoch=val_min_train_steps_per_epoch if val_min_train_steps_per_epoch != 0 else 1,
#             shuffle=False,
...
#             accelerator=self.config.trainer_config.trainer_accelerator,
#             enable_progress_bar=self.config.trainer_config.enable_progress_bar,
#             limit_train_batches=self.min_train_steps_per_epoch,
#             strategy=strategy,
#             profiler=profiler,
#             log_every_n_steps=1,
#         )  # TODO check any other methods to use rank in dataset creations!
