...
- `trainer_config`: 
    ...
    - `model_ckpt`:
        ...
        - `enable_version_counter` – Whether to append a version to the existing file name. If this is False, then the checkpoint files will be overwritten. *Default*: True.
