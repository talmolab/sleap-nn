...
Configure and train pose estimation models. Start with the main guide, then
explore the focused topics below.

| Page | Description |
|------|-------------|
| [Training Guide](../training-guide.md) | Configure and run model training |
